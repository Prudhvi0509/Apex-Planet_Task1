...
Modern CSS3 Design: Features a professional linear-gradient background, Google Fonts (Roboto) integration, and responsive layout techniques.

Interactive Elements: A JavaScript-powered button that provides immediate user feedback via an alert.
...
styles.css — Custom stylesheet for the project's visual design.

script.js — Interactive logic and functions.

webpage.png — Asset used for the page layout.

🌐 Live Preview

View the project live in your browser:
https://prudhvi0509.github.io/Apex-Planet_Task1/
